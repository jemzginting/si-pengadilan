...
class CetakControl extends CI_Controller
{
    ...
    public function generate_RekapPDF($bulan = false, $tahun = false)
    {
        $data = array();
        $htmlContent = '';
        $bln = $bulan;
        ...
        $data['list'] = $this->createpdf->getRekapBulan($bln, $thn);
        //var_dump($data);
        $data['bulan'] = $bln;
        $data['tahun'] = $thn;
        $htmlContent = $this->load->view('template/cetak/rekap', $data, TRUE);
